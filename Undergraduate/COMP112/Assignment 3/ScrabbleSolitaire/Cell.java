...
/**
 * Stores the data for each of the cells in the board, Is a simplier way
 * of containing all the information in a cell
 */
public class Cell
{
    // Static variables
    ...
    public Cell(CellType t, int x, int y)
    {
        ...
        // Choose the paint based on what sort of cell it is 
     ...
     */
    public boolean hasBeenScored() {return hasBeenScored; }
    
    /**
     * Sets the hasBeenScored flag to true
     */
    public void scored() { hasBeenScored = true; }
     ...
     */
    public boolean containsTile() { return ( tile != null ); }
