...
/**
 * Write a description of class ProjectedMoleculeRenderer here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class ProjectedMoleculeRenderer extends JPanel
{
    ...
    public ProjectedMoleculeRenderer()
    {
        readElementTable();
    ...
    {   
        ...
        for( Atom a : molecule )
        {
            //a.draw(g2d, currentPanAngle);
            projection.drawCircle(g2d, new Point3D(a.getX(), a.getY(), a.getZ()), a.getColor(), a.getRadius());
        }
