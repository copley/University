...
public class ImageNode {
    ...
    public void insertBefore(ImageNode newNode, ImageNode cursor) {
        ImageNode imageBefore = nodeBefore(cursor);
        imageBefore.insertAfter(newNode);
    } 
    ...
    private ImageNode nodeBeforeRec(ImageNode target) 
    {
        ...
        else return next.nodeBefore(target);
    }
    ...
    {
        //if( next != null ) previous = next.reverseUsingPrevious(this);
        
        //this.insertAfter(previous);
        //return this;
        if( next != null ) 
        {
            ImageNode newStart = next.reverseUsingPrevious(this);
            
            // Find the end of the new linked list
            ImageNode newEnd = newStart;
            while( newEnd.next != null ) newEnd = newEnd.next;
            
            newEnd.insertAfter(previous);
