...
public class LessThanEqualToConditionNode extends ConditionNode {

	private ExpressionNode expression1;
	private ExpressionNode expression2;
	
	private LessThanEqualToConditionNode(ExpressionNode e1, ExpressionNode e2) {
		expression1 = e1;
		expression2 = e2;
	}
	...
	public static ConditionNode ParseLessThanEqualToConditionNode(LookAheadScanner s) {
		...
		return new LessThanEqualToConditionNode(e1, e2);
	}
