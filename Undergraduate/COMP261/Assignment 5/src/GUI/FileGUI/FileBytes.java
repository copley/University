...
public class FileBytes{
    ...
    */
	...
	System.out.printf("a: %d.%d.%d.%d\n",
			  FileBytes.byteToInt(a[0]), FileBytes.byteToInt(a[1]),
			  FileBytes.byteToInt(a[2]), FileBytes.byteToInt(a[3]));
	System.out.printf("b: %d.%d.%d.%d\n",
			  FileBytes.byteToInt(b[0]), FileBytes.byteToInt(b[1]),
			  FileBytes.byteToInt(b[2]), FileBytes.byteToInt(b[3]));
	System.out.printf("c: %d.%d.%d \n",
			  FileBytes.byteToInt(c[0]), FileBytes.byteToInt(c[1]),
			  FileBytes.byteToInt(c[2]));
