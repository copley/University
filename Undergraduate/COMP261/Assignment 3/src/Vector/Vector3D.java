...
public class Vector3D {
	...
	private ArrayList<Polygon> connected; 
	...
	public void addConnected(Polygon p) {
		connected.add(p);
	}
	...
	public Vector3D vectorNormal() {
		...
		for (Polygon p : connected) {
			Vector3D n = p.getUnitNormalToSurface();
		...
		return new Vector3D(totalX / connected.size(), totalY / connected.size(), totalZ / connected.size());
	}
