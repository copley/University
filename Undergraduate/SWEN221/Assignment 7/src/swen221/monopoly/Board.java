...
public class Board {
	...
	public Board() {
		...
		Street coventry = new Street("Coventry Street", 260, 22);
		...
		new ColourGroup("Yellow", leceister, coventry, picadilly);
	...
	/**
	 * Find location which is a given number of steps along from location
	 * argument.
	 */
