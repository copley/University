...
def readheaders():
    ...
    """
    line = raw_input("Data description. Blank line ends: ")
    heading = line
    while line:
        line = raw_input("")
        if line:
            heading += "\n# "+line
    observer = raw_input("please enter the observer's name: ")
    filename = raw_input("please enter the name of the file to be written to: ")
