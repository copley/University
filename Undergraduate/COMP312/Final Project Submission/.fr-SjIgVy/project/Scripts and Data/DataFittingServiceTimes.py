...
print "The chi_sq test value for exponential is %10.6f and the p-value is %10.6f" % (exp[0], exp[1])
dof = 2
n = 30
print "The chi_sq test value for erlang is %10.20f and the p-value is %10.20f" % (chiSquare.model(service_times, n, dof, rv=rv2)[0], chiSquare.model(service_times,n,dof,rv= rv2)[1])
print "The chi_sq test value for gamma is %10.6f and the p-value is %10.6f" % (chiSquare.model(service_times, n, dof, rv=rv3)[0], chiSquare.model(service_times,n,dof,rv= rv3)[1])
plt.show()
