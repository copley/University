...
public class ControllerTest {
	...
	public void testInitInvalid() {
		controller.setNumberOfPlayers(3);
		controller.addPlayerCharacter(PlayerCharacter.COLONEL_MUSTARD);
	...
	public void testInitValid() {
		controller.setNumberOfPlayers(3);
		controller.addPlayerCharacter(PlayerCharacter.COLONEL_MUSTARD);
		controller.addPlayerCharacter(PlayerCharacter.MRS_PEACOCK);
		controller.addPlayerCharacter(PlayerCharacter.THE_REVEREND_GREEN);
